...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCameraActivity = findViewById(R.id.buttonCameraActivity);
        buttonCameraActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                switchToRealCameraPage();
            }
        });
    }
    ...
    private void switchToRealCameraPage() {
        Intent switchActivityIntent = new Intent(this, CameraReal.class);
        startActivity(switchActivityIntent);
    }
